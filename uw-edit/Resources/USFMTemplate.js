...
var knownTags = [
    ...
    new RegExp('(\\\\p)(\\s+)'),                // paragraph
    new RegExp('(\\\\v [0-9-]+)(\\s+)'),        // verse
    new RegExp('(\\\\c [0-9]+)(\\s+)')          // chapter
];
