...
namespace SIL.PlatformUtilities
{
	...
	{
		static readonly string UnixNameMac = "Darwin";
		static readonly string UnixNameLinux = "Linux";
		static bool? _isMono;
		static string _unixName;
		static string _sessionManager;
		...
		{
			get { return IsUnix && SessionManager.StartsWith("/usr/bin/cinnamon-session", StringComparison.Ordinal); }
		}
